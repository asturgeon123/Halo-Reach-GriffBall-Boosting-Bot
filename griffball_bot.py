...
-----------------------------------------------------------------------------
	...
	#gradient_print(logo_text, start_color=0x4BBEE3, end_color=Color.medium_violet_red)

	rgbprint(logo_text, color=Color.medium_violet_red)
...
def main():
	...
	if capture.center is None:
		...
		rgbprint(' -  Click into the game when a minimap is visible and calibration will start automatically. NOTE: Two Screens will popup on after the other...',color=Color.medium_violet_red)
